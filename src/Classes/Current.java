...
public class Current extends Client{
    ...
    public Current(String clientName, String clientPassword, String clientAccNum , int clientAge) {
    ...
    public void withdraw() throws InterruptedException {
        ...
        System.out.println("The amount was withdrawn successfully out of your account! + 5$ Withdrawl fee");
        System.out.println("Your current balance : " + clientBalance + "$\n");
        System.out.println("[1] Back to main menu");
